...
static void draw_triangle_span(uint32_t* image,
                               int32_t   image_width,
...
static void draw_triangle_span_edge(uint32_t*    image,
                                    int32_t      image_width,
                                    int32_t      image_height,
                                    span_edge_t& e0,
                                    span_edge_t& e1) {
  ...
  for(float y = e1.v0.y; y < e1.v1.y; y += 1.0f) {
    point2d_t start{ e0.v0.x + static_cast<int32_t>(e0xdiff * e0factor),
                     y,
                     e0.v0.r + (e0colordiff_r * e0factor),
                     e0.v0.g + (e0colordiff_g * e0factor),
                     e0.v0.b + (e0colordiff_b * e0factor) };

    point2d_t end{ e1.v0.x + static_cast<int32_t>(e1xdiff * e1factor),
                   y,
...
void draw_triangle_joshbeam(uint32_t*        image,
                            int32_t          image_width,
                            int32_t          image_height,
                            const point2d_t& v0,
                            const point2d_t& v1,
